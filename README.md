...
## Project View
- Homepage
 ![homepage](/blob/main/Screenshots/homepage.PNG)
- Enter coursecode\ 
  (When user submit the coursecode, in background mongodb collection with name of coursecode is created to save further data)
  ![coursecode](/blob/main/Screenshots/coursecode.PNG)
- Forms
  ![forms](/blob/main/Screenshots/form1.PNG)
- Download coursebook
  ![download](/blob/main/Screenshots/download.PNG)
